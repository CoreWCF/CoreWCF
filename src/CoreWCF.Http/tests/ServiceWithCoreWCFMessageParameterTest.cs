...
namespace BasicHttp
{
    public class ServiceWithCoreWCFMessageParameterTest : IClassFixture<IntegrationTest<ServiceWithCoreWCFMessageParameterTest.Startup>>
    {
        private readonly ITestOutputHelper _output;
        private readonly IntegrationTest<Startup> _factory;

        public ServiceWithCoreWCFMessageParameterTest(ITestOutputHelper output, IntegrationTest<Startup> factory)
        {
            _output = output;
            _factory = factory;
        }
        ...
        public void BasicScenarioServiceMessageParameter()
        {
            ...
            using (host)
            {
                ...
                var factory = new System.ServiceModel.ChannelFactory<ClientContract.IServiceWithCoreWCFMessageParameter>(httpBinding,
                    new System.ServiceModel.EndpointAddress(new Uri("http://localhost:8080/BasicWcfService/Service.svc")));
                IServiceWithCoreWCFMessageParameter channel = factory.CreateChannel();
        ...
        public async Task BasicScenarioServiceMessageParameterWithHttpClient()
        {
            ...
            const string action = "http://tempuri.org/IServiceWithCoreWCFMessageParameter/Identity";
      ...
      <tem:Identity>
        ...
        public class Startup
        {
            ...
            public void Configure(IApplicationBuilder app, IHostingEnvironment env)
            {
                ...
                {
                    builder.AddService<Services.ServiceWithCoreWCFMessageParameter>();
                    builder.AddServiceEndpoint<Services.ServiceWithCoreWCFMessageParameter, Services.IServiceWithCoreWCFMessageParameter>(new BasicHttpBinding(), "/BasicWcfService/Service.svc");
                });
            }
        }
    }
