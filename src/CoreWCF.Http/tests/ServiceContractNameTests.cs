...
namespace CoreWCF.Http.Tests
{
    public class ServiceContractNameTests
    {
        ...
        public async Task ServiceContractName_784749(string method, string clientString)
        {
        ...
        {
            // Create the proxy
            ClientContract.IServiceContractName_784749_XmlCharacters_Service clientProxy = ClientHelper.GetProxy<ClientContract.IServiceContractName_784749_XmlCharacters_Service>(host);
        ...
        {
            // Create the proxy
            ClientContract.IServiceContractName_784749_WhiteSpace_Service clientProxy = ClientHelper.GetProxy<ClientContract.IServiceContractName_784749_WhiteSpace_Service>(host);
            // Send the two way message
        ...
        {
            // Create the proxy
            ClientContract.IServiceContractName_784749_XMLEncoded_Service clientProxy = ClientHelper.GetProxy<ClientContract.IServiceContractName_784749_XMLEncoded_Service>(host);
            // Send the two way message
        ...
        {
            // Create the proxy
            ClientContract.IServiceContractName_784749_NonAlphaCharacters_Service clientProxy = ClientHelper.GetProxy<ClientContract.IServiceContractName_784749_NonAlphaCharacters_Service>(host);
            // Send the two way message
        ...
        {
            // Create the proxy
            ClientContract.IServiceContractName_784749_LocalizedCharacters_Service clientProxy = ClientHelper.GetProxy<ClientContract.IServiceContractName_784749_LocalizedCharacters_Service>(host);
            // Send the two way message
        ...
        {
            // Create the proxy
            ClientContract.IServiceContractName_784749_SurrogateCharacters_Service clientProxy = ClientHelper.GetProxy<ClientContract.IServiceContractName_784749_SurrogateCharacters_Service>(host);
            // Send the two way message
        ...
        {
            // Create the proxy
            ClientContract.IServiceContractName_784749_XMLReservedCharacters_Service clientProxy = ClientHelper.GetProxy<ClientContract.IServiceContractName_784749_XMLReservedCharacters_Service>(host);
            // Send the two way message
        ...
        {
            // Create the proxy
            ClientContract.IServiceContractName_784749_URI_Service clientProxy = ClientHelper.GetProxy<ClientContract.IServiceContractName_784749_URI_Service>(host);
            // Send the two way message
