...
namespace CoreWCF.Http.Tests
{
    public class ServiceContractNameTests
    {
        ...
        public void SerivceContractName_784749(string method, string clientString)
        {
            ...
            _host = ServiceHelper.CreateWebHostBuilder<SerivceContractName>(_output).Build();
            using (_host)
            {
                _host.Start();
                string result;
        ...
        {
            // Create the proxy
            ClientContract.IServiceContractName_784749_XmlCharacters_Service clientProxy = ClientHelper.GetProxy<ClientContract.IServiceContractName_784749_XmlCharacters_Service>(_host);
        ...
        {
            // Create the proxy
            ClientContract.IServiceContractName_784749_WhiteSpace_Service clientProxy = ClientHelper.GetProxy<ClientContract.IServiceContractName_784749_WhiteSpace_Service>(_host);
            // Send the two way message
        ...
        {
            // Create the proxy
            ClientContract.IServiceContractName_784749_XMLEncoded_Service clientProxy = ClientHelper.GetProxy<ClientContract.IServiceContractName_784749_XMLEncoded_Service>(_host);
            // Send the two way message
        ...
        {
            // Create the proxy
            ClientContract.IServiceContractName_784749_NonAlphaCharacters_Service clientProxy = ClientHelper.GetProxy<ClientContract.IServiceContractName_784749_NonAlphaCharacters_Service>(_host);
            // Send the two way message
        ...
        {
            // Create the proxy
            ClientContract.IServiceContractName_784749_LocalizedCharacters_Service clientProxy = ClientHelper.GetProxy<ClientContract.IServiceContractName_784749_LocalizedCharacters_Service>(_host);
            // Send the two way message
        ...
        {
            // Create the proxy
            ClientContract.IServiceContractName_784749_SurrogateCharacters_Service clientProxy = ClientHelper.GetProxy<ClientContract.IServiceContractName_784749_SurrogateCharacters_Service>(_host);
            // Send the two way message
        ...
        {
            // Create the proxy
            ClientContract.IServiceContractName_784749_XMLReservedCharacters_Service clientProxy = ClientHelper.GetProxy<ClientContract.IServiceContractName_784749_XMLReservedCharacters_Service>(_host);
            // Send the two way message
        ...
        {
            // Create the proxy
            ClientContract.IServiceContractName_784749_URI_Service clientProxy = ClientHelper.GetProxy<ClientContract.IServiceContractName_784749_URI_Service>(_host);
            // Send the two way message
