...
namespace System.Xml.XmlDiff
{
    ...
    public class XmlDiffAdvancedOptions
    {
        ...
        public IDictionary<string, string> AddedNamespaces { get; private set; }

        public XmlDiffAdvancedOptions()
        {
            AddedNamespaces = new Dictionary<string, string>();
        }

        public void AddNamespace(string prefix, string uri)
        {
            AddedNamespaces[prefix] = uri;
        }

        public bool HadAddedNamespace()
        {
            return 0 != AddedNamespaces.Count;
        }
    }
}
