...
namespace System.Xml.XmlDiff
{
    ...
    public class XmlDiffNavigator : XPathNavigator
    {
        ...
        {
            return attr.LocalName.ToLower(Globalization.CultureInfo.InvariantCulture) == "xmlns" ||
                   attr.Prefix.ToLower(Globalization.CultureInfo.InvariantCulture) == "xmlns";
        }
        ...
        public override string Name
        {
            get
            {
                if (CurrentNode.NodeType == XmlDiffNodeType.Element)
                {
                    ...
                    return m_document.NameTable.Get(((XmlDiffElement)CurrentNode).Name);
                }
                else if (CurrentNode.NodeType == XmlDiffNodeType.Attribute)
                {
        ...
        public override bool HasAttributes
        {
            get
            {
                return (CurrentNode is XmlDiffElement && ((XmlDiffElement)CurrentNode).FirstAttribute != null) ? true : false;
            }
        }
        ...
        public override bool HasChildren
        {
            get
            {
                return CurrentNode._next != null ? true : false;
            }
        }
        ...
        public override bool IsEmptyElement
        {
            get
            {
                return CurrentNode is XmlDiffEmptyElement ? true : false;
            }
        }
