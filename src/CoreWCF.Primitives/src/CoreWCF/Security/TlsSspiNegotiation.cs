...
using DiagnosticUtility = CoreWCF.DiagnosticUtility;
using SR = CoreWCF.SR;
using System;
...
#pragma warning suppress 56503
        ...
        static void ValidatePrivateKey(X509Certificate2 certificate)
        {
            ...
            try
            {
                if (CoreWCF.LocalAppContextSwitches.DisableCngCertificates)
                {
        ...
        public bool IsValidContext => throw new NotImplementedException();

        public string KeyEncryptionAlgorithm => throw new NotImplementedException();
        ...
        public byte[] GetOutgoingBlob(byte[] incomingBlob, ChannelBinding channelbinding, ExtendedProtectionPolicy protectionPolicy) => throw new NotImplementedException();
        public string GetRemoteIdentityName() => throw new NotImplementedException();
    }
}
