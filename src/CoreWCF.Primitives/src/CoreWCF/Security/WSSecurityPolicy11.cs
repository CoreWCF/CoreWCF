...
namespace CoreWCF.Security
{
    internal class WSSecurityPolicy11 : WSSecurityPolicy
    {
        ...
        public override XmlElement CreateWsspHttpsTokenAssertion(MetadataExporter exporter, object /*HttpsTransportBindingElement*/ httpsBinding)
        {
            throw new System.Exception("Work out another way to do this");
