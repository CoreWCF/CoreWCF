...
namespace CoreWCF.Security
{
    internal abstract class WSSecurityPolicy
    {
        ...
        public virtual string AlwaysToRecipientUri => this.WsspNamespaceUri + @"/IncludeToken/AlwaysToRecipient";
        public virtual string NeverUri => this.WsspNamespaceUri + @"/IncludeToken/Never";
        public virtual string OnceUri => this.WsspNamespaceUri + @"/IncludeToken/Once";
        public virtual string AlwaysToInitiatorUri => this.WsspNamespaceUri + @"/IncludeToken/AlwaysToInitiator";
        ...
        public abstract XmlElement CreateWsspHttpsTokenAssertion(MetadataExporter exporter, object /*HttpsTransportBindingElement*/ httpsBinding);
