...
namespace CoreWCF.Security
{
    public class SamlSerializer
    {
        ...
        public virtual IdentityModel.Tokens.SamlSecurityToken ReadToken(XmlDictionaryReader reader, SecurityTokenSerializer keyInfoSerializer, SecurityTokenResolver outOfBandTokenResolver)
        {
            if (reader == null)
            {
