...
namespace CoreWCF.Description
{
    public class WsdlExporter : MetadataExporter
    {
        ...
        private readonly Dictionary<ContractDescription, WsdlContractConversionContext> _exportedContracts
        ...
        {
            ExportEndpoints(endpoints, wsdlServiceQName, null);
        }
        ...
        public static void AddWSAddressingAssertion(MetadataExporter exporter, PolicyConversionContext context, AddressingVersion addressing)
        {
            WSAddressingHelper.AddWSAddressingAssertion(exporter, context, addressing);
        }
        ...
        public static void AddAddressToWsdlPort(WsdlNS.Port wsdlPort, EndpointAddress address, AddressingVersion addressingVersion)
        {
            WSAddressingHelper.AddAddressToWsdlPort(wsdlPort, address, addressingVersion);
        }
        ...
        {
            return OperationIsExportable(operation, out _);
        }
        ...
        private class WSPolicyAttachmentHelper
        {
            ...
            internal void AttachPolicy(ServiceEndpoint endpoint, WsdlEndpointConversionContext endpointContext, PolicyConversionContext policyContext)
            {
                ...
                Func<string,object,bool> policyKeyIsUnique
                    = (string name, object nameCollection) =>
                    {
                ...
                if (assertions.Count > 0)
                {
                    ...
                    key = WsdlNamingHelper.GetUniqueName(keyBase, policyKeyIsUnique, null);
        ...
        internal static class WsdlNamingHelper
        {
            ...
            internal static XmlQualifiedName GetBindingQName(ServiceEndpoint endpoint, WsdlExporter exporter, out bool wasUniquified)
            {
                ...
                string uniquifiedLocalName = GetUniqueName(localName, WsdlBindingQNameExists(exporter, bindingWsdlNamespace), null);
                wasUniquified = localName != uniquifiedLocalName;

                return new XmlQualifiedName(uniquifiedLocalName, bindingWsdlNamespace);
            }

            private static Func<string, object, bool> WsdlBindingQNameExists(WsdlExporter exporter, string bindingWsdlNamespace)
            {
                return (string localName, object nameCollection) =>
                {
            ...
            {
                return GetUniqueName(endpoint.Name, ServiceContainsPort(wsdlService), null);
            }

            private static Func<string, object, bool> ServiceContainsPort(WsdlNS.Service service)
            {
            ...
            internal static string GetWsdlOperationName(OperationDescription operationDescription)
            {
        ...
        internal static class NetSessionHelper
        {
            ...
            {
                wsdlOperation.ExtensibleAttributes = CloneAndAddToAttributes(wsdlOperation.ExtensibleAttributes, Prefix,
        ...
        private sealed class BindingDictionaryKey
        {
            ...
            {
                return Contract.GetHashCode() ^ Binding.GetHashCode();
            }
        }
        ...
        private sealed class EndpointDictionaryKey
        {
            ...
            public override int GetHashCode()
            {
                return Endpoint.GetHashCode() ^ ServiceQName.GetHashCode();
            }
        }
    }
}
