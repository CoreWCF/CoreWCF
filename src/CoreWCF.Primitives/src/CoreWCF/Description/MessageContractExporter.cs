    ...
    abstract class MessageContractExporter
    {
        ...
        protected XsdDataContractExporterEx DataContractExporter
        {
            get
            {
                ...
                if (!exporter.State.TryGetValue(typeof(XsdDataContractExporterEx), out dataContractExporter))
                {
                    dataContractExporter = new XsdDataContractExporterEx(this.exporter.GeneratedXmlSchemas);
                    exporter.State.Add(typeof(XsdDataContractExporterEx), dataContractExporter);
                }
