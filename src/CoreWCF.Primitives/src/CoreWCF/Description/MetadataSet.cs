...
#pragma warning disable
    ...
    internal class XmlSerializationWriterMetadataSet : System.Xml.Serialization.XmlSerializationWriter
    {
        ...
        public void Write68_Metadata(object o)
        {
            ...
            Write67_MetadataSet(@"Metadata", @"http://schemas.xmlsoap.org/ws/2004/09/mex", ((global::CoreWCF.Description.MetadataSet)o), true, false);
        }

        void Write67_MetadataSet(string n, string ns, global::CoreWCF.Description.MetadataSet o, bool isNullable, bool needType)
        {
            if (processOuterElement)
            {
                if ((object)o == null)
            ...
            if (!needType)
            {
                ...
                if (t == typeof(global::CoreWCF.Description.MetadataSet))
                {
                }
                else
                {
            ...
            {
                global::System.Collections.ObjectModel.Collection<global::CoreWCF.Description.MetadataSection> a = (global::System.Collections.ObjectModel.Collection<global::CoreWCF.Description.MetadataSection>)o.@MetadataSections;
                if (a != null)
                {
                    for (int ia = 0; ia < ((System.Collections.ICollection)a).Count; ia++)
                    {
                        Write66_MetadataSection(@"MetadataSection", @"http://schemas.xmlsoap.org/ws/2004/09/mex", ((global::CoreWCF.Description.MetadataSection)a[ia]), false, false);
                    }
                }
            }
            if (processOuterElement)
        ...
        void Write66_MetadataSection(string n, string ns, global::CoreWCF.Description.MetadataSection o, bool isNullable, bool needType)
        {
            if ((object)o == null)
            {
                if (isNullable) WriteNullTagLiteral(n, ns);
            ...
            {
                System.Type t = o.GetType();
                if (t == typeof(global::CoreWCF.Description.MetadataSection))
                {
                }
                else
                {
            ...
            WriteAttribute(@"Identifier", @"", ((global::System.String)o.@Identifier));
            {
                ...
                else if (o.@Metadata is global::CoreWCF.Description.MetadataSet)
                {
                    Write67_MetadataSet(@"Metadata", @"http://schemas.xmlsoap.org/ws/2004/09/mex", ((global::CoreWCF.Description.MetadataSet)o.@Metadata), false, false);
                }
                else if (o.@Metadata is global::CoreWCF.Description.MetadataLocation)
                {
                    Write65_MetadataLocation(@"Location", @"http://schemas.xmlsoap.org/ws/2004/09/mex", ((global::CoreWCF.Description.MetadataLocation)o.@Metadata), false, false);
                }
                else if (o.@Metadata is global::CoreWCF.Description.MetadataReference)
                {
                    WriteSerializable((System.Xml.Serialization.IXmlSerializable)((global::CoreWCF.Description.MetadataReference)o.@Metadata), @"MetadataReference", @"http://schemas.xmlsoap.org/ws/2004/09/mex", false, true);
                }
        ...
        void Write65_MetadataLocation(string n, string ns, global::CoreWCF.Description.MetadataLocation o, bool isNullable, bool needType)
        {
            if ((object)o == null)
            {
                if (isNullable) WriteNullTagLiteral(n, ns);
            ...
            {
                System.Type t = o.GetType();
                if (t == typeof(global::CoreWCF.Description.MetadataLocation))
                {
                }
                else
                {
    ...
    internal class XmlSerializationReaderMetadataSet : System.Xml.Serialization.XmlSerializationReader
    {
        ...
        global::CoreWCF.Description.MetadataSet Read67_MetadataSet(bool isNullable, bool checkType)
        {
            ...
            global::CoreWCF.Description.MetadataSet o;
            o = new global::CoreWCF.Description.MetadataSet();
            global::System.Collections.ObjectModel.Collection<global::CoreWCF.Description.MetadataSection> a_0 = (global::System.Collections.ObjectModel.Collection<global::CoreWCF.Description.MetadataSection>)o.@MetadataSections;
        ...
        global::CoreWCF.Description.MetadataSection Read66_MetadataSection(bool isNullable, bool checkType)
        {
            System.Xml.XmlQualifiedName xsiType = checkType ? GetXsiType() : null;
            bool isNull = false;
            if (isNullable) isNull = ReadNull();
            ...
            if (isNull) return null;
            global::CoreWCF.Description.MetadataSection o;
            o = new global::CoreWCF.Description.MetadataSection();
            ...
            while (Reader.NodeType != System.Xml.XmlNodeType.EndElement && Reader.NodeType != System.Xml.XmlNodeType.None)
            {
                if (Reader.NodeType == System.Xml.XmlNodeType.Element)
                {
                    ...
                    {
                        o.@Metadata = (global::CoreWCF.Description.MetadataReference)ReadSerializable((System.Xml.Serialization.IXmlSerializable)System.Activator.CreateInstance(typeof(global::CoreWCF.Description.MetadataReference), System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.CreateInstance | System.Reflection.BindingFlags.NonPublic, null, new object[0], null));
                        paramsRead[3] = true;
                    }
        ...
        global::CoreWCF.Description.MetadataLocation Read65_MetadataLocation(bool isNullable, bool checkType)
        {
            System.Xml.XmlQualifiedName xsiType = checkType ? GetXsiType() : null;
            bool isNull = false;
            if (isNullable) isNull = ReadNull();
            ...
            if (isNull) return null;
            global::CoreWCF.Description.MetadataLocation o;
            o = new global::CoreWCF.Description.MetadataLocation();
    ...
    internal class XmlSerializerContract : global::System.Xml.Serialization.XmlSerializerImplementation
    {
        ...
        {
            if (type == typeof(global::CoreWCF.Description.MetadataSet)) return true;
            return false;
        }
        public override System.Xml.Serialization.XmlSerializer GetSerializer(System.Type type)
        {
            if (type == typeof(global::CoreWCF.Description.MetadataSet)) return new MetadataSetSerializer();
            return null;
        }
    }
