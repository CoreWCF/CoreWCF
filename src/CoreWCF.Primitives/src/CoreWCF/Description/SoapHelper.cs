...
namespace CoreWCF.Description
{
    internal static class SoapHelper
    {
        ...
        //// -----------------------------------------------------------------------------------------------------------------------
        //// Developers Note: We go through a little song and dance here to Get or Create an exsisting SoapBinding from the WSDL
        ...
        ////      2. There are diffrent classes for different SOAP versions and the extensions that determines the version is
        ...
        public static WsdlNS.SoapBinding GetOrCreateSoapBinding(WsdlEndpointConversionContext endpointContext, WsdlExporter exporter)
        {
        ...
        internal static WsdlNS.SoapBinding CreateSoapBinding(EnvelopeVersion version, WsdlNS.Binding wsdlBinding)
        {
        ...
        public static WsdlNS.SoapAddressBinding GetSoapAddressBinding(WsdlNS.Port wsdlPort)
        {
        ...
        internal static WsdlNS.SoapBinding GetSoapBinding(WsdlEndpointConversionContext endpointContext)
        {
        ...
        private static WsdlNS.SoapOperationBinding GetSoapOperationBinding(WsdlEndpointConversionContext endpointContext, OperationDescription operation)
        {
            ...
            {
                if (o is WsdlNS.SoapOperationBinding binding)
                {
                    return binding;
                }
            }
        ...
        private static WsdlNS.SoapBodyBinding GetSoapBodyBinding(WsdlEndpointConversionContext endpointContext, WsdlNS.MessageBinding wsdlMessageBinding)
        {
            ...
            {
                if (o is WsdlNS.SoapBodyBinding binding)
                {
                    return binding;
                }
            }
