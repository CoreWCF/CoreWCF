...
{
    //sealed class SignedXmlOld : ISignatureValueSecurityElement
    //{
    ...
    //                        SR.Format("UnableToCreateKeyedHashAlgorithm", symmetricKey, signatureMethod)));
    //                }
    ...
    //            {
    //                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(
    //                    SR.Format(SR.UnknownICryptoType, signingKey)));
    //            }
    ...
    //                {
    //                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(
    //                        SR.Format("UnableToCreateHashAlgorithmFromAsymmetricCrypto", signatureMethod, asymmetricKey)));
    //                }
    ...
    //                {
    //                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(
    //                        SR.Format("UnableToCreateSignatureFormatterFromAsymmetricCrypto", signatureMethod, asymmetricKey)));
    //                }
    ...
    //        {
    //            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new CryptographicException(SR.Format(SR.SignatureVerificationFailed)));
    //        }
    //    }
    ...
    //                        SR.Format("UnableToCreateKeyedHashAlgorithmFromSymmetricCrypto", signatureMethod, symmetricKey)));
    //                }
    ...
    //                {
    //                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new CryptographicException(
    //                        SR.Format("UnableToCreateSignatureDeformatterFromAsymmetricCrypto", signatureMethod, asymmetricKey)));
    //                }
...
//                {
//                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotSupportedException(SR.Format(SR.UnsupportedTransformAlgorithm)));
//                }
//            }
//        }
...
//            {
//                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new CryptographicException(SR.Format(SR.UnsupportedTransformAlgorithm)));
//            }
...
//                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new CryptographicException(SR.Format(SR.InclusiveNamespacePrefixRequiresSignatureReader)));
...
//            {
//                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new CryptographicException(
//                    SR.Format("RequiredTargetNotSigned", id)));
//            }
//        }
...
//                        new CryptographicException(SR.Format(SR.UnableToResolveReferenceUriForSignature, this.references[i].Uri)));
//                }
//            }
//        }
...
//            {
//                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new CryptographicException(SR.Format(SR.AtLeastOneReferenceRequired)));
//            }
//            for (int i = 0; i < this.references.Count; i++)
//            {
...
//            {
//                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new CryptographicException(
//                    SR.Format(SR.RequiredTargetNotSigned, id)));
//            }
//        }
...
//            {
//                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
//                    new CryptographicException(SR.Format(SR.DigestVerificationFailedForReference, this.uri)));
//            }
//            this.verified = true;
//            return true;
//        }
...
//            {
//                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
//                    new CryptographicException(SR.Format("DigestVerificationFailedForReference", this.uri)));
//            }
//            this.verified = true;
//            return true;
//        }
...
//                {
//                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
//                        new CryptographicException(SR.Format(SR.UnableToResolveReferenceUriForSignature, this.uri)));
//                }
...
//            {
//                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotSupportedException(SR.Format("EmptyTransformChainNotSupported")));
//            }

//            if (this.resolvedXmlSource == null)
//            {
//                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new CryptographicException(
//                    SR.Format(SR.UnableToResolveReferenceUriForSignature, this.uri)));
//            }
...
//            {
//                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new CryptographicException(SR.Format(SR.AtLeastOneTransformRequired)));
//            }
//        }
...
//            {
//                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new CryptographicException(
//                    SR.Format(SR.RequiredAttributeMissing, dictionaryManager.XmlSignatureDictionary.Algorithm, this.elementName)));
//            }
//            reader.Read();
//            reader.MoveToContent();
