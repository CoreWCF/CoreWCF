...
namespace CoreWCF.IdentityModel.Tokens
{
    ...
    public abstract class SecurityTokenHandler //: ICustomIdentityConfiguration
    {
        ...
        public virtual SecurityToken ReadToken(XmlReader reader) => throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotImplementedException(SR.Format(SR.ID4008, "SecurityTokenHandler", "ReadToken")));
        ...
        public virtual SecurityToken ReadToken(string tokenString) => throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotImplementedException(SR.Format(SR.ID4008, "SecurityTokenHandler", "ReadToken")));
        ...
        public virtual void WriteToken(XmlWriter writer, SecurityToken token) => throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotImplementedException(SR.Format(SR.ID4008, "SecurityTokenHandler", "WriteToken")));
        ...
        public virtual string WriteToken(SecurityToken token) => throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotImplementedException(SR.Format(SR.ID4008, "SecurityTokenHandler", "WriteToken")));
        ...
        public virtual SecurityKeyIdentifierClause ReadKeyIdentifierClause(XmlReader reader) => throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotImplementedException(SR.Format(SR.ID4008, "SecurityTokenHandler", "ReadKeyIdentifierClause")));
        ...
        public virtual bool CanWriteKeyIdentifierClause(SecurityKeyIdentifierClause securityKeyIdentifierClause) => false;
        ...
        public virtual void WriteKeyIdentifierClause(XmlWriter writer, SecurityKeyIdentifierClause securityKeyIdentifierClause) => throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotImplementedException(SR.Format(SR.ID4008, "SecurityTokenHandler", "WriteKeyIdentifierClause")));
        ...
        public virtual SecurityToken CreateToken(SecurityTokenDescriptor tokenDescriptor) => throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotImplementedException(SR.Format(SR.ID4008, "SecurityTokenHandler", "CreateToken")));
        ...
        public virtual SecurityKeyIdentifierClause CreateSecurityTokenReference(SecurityToken token, bool attached) => throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotImplementedException(SR.Format(SR.ID4008, "SecurityTokenHandler", "CreateSecurityTokenReference")));
        ...
        public virtual ReadOnlyCollection<ClaimsIdentity> ValidateToken(SecurityToken token) => throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotImplementedException(SR.Format(SR.ID4008, "SecurityTokenHandler", "ValidateToken")));
