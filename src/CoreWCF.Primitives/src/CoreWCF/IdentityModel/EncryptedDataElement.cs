...
namespace CoreWCF.IdentityModel
{
    ...
    internal class EncryptedDataElement : EncryptedTypeElement
    {
        ...
        public byte[] Decrypt( SymmetricAlgorithm algorithm )
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError( new InvalidOperationException( SR.Format( SR.ID6000 ) ) );
            }
        ...
        static byte[] ExtractIVAndDecrypt( SymmetricAlgorithm algorithm, byte[] cipherText, int offset, int count )
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError( new InvalidOperationException( SR.Format( SR.ID6019, cipherText.Length - offset, iv.Length ) ) );
            }
        ...
        public override void ReadXml( XmlDictionaryReader reader )
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperXml( reader, SR.Format( SR.ID4193 ) );
            }
        ...
        public virtual void WriteXml( XmlWriter writer, SecurityTokenSerializer securityTokenSerializer )
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError( new InvalidOperationException( SR.Format( SR.ID6001 ) ) );
            }
