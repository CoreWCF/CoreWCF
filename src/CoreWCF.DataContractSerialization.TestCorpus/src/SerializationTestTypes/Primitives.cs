...
//
// Copied verbatim from dotnet/runtime at bbfaee3bfa7edb0d556556bc32778d09a745134b:
// https://github.com/dotnet/runtime/blob/bbfaee3bfa7edb0d556556bc32778d09a745134b/src/libraries/System.Runtime.Serialization.Xml/tests/SerializationTestTypes/Primitives.cs
...
namespace SerializationTestTypes
{
    ...
    // CoreWCF: guarded for .NET Framework, where DateOnly and TimeOnly do not exist. The corpus
    // spans $(TestTargetFrameworks), which still includes net472 on Windows. The corresponding
    // catalog registration carries the same guard, so the case is excluded rather than silently
    // dropped.
#if !NETFRAMEWORK
    [DataContract]
