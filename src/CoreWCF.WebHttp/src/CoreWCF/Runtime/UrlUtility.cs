...
namespace CoreWCF.Runtime
{
    internal static class UrlUtility
    {
        ...
        internal static NameValueCollection ParseQueryString(string query, Encoding encoding)
        {
            if (query == null)
            {
                throw Fx.Exception.ArgumentNull(nameof(query));
            }

            if (encoding == null)
            {
                throw Fx.Exception.ArgumentNull(nameof(encoding));
            }
        ...
        internal static string UrlEncode(string str, Encoding encoding)
        {
            if (str == null)
            {
                return null;
    ...
    internal class HttpValueCollection : NameValueCollection
    {
        ...
        public override string ToString() => ToString(true, null);
