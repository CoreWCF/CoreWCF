...
namespace Microsoft.ServiceModel.Channels
{
    internal static class TransportDefaults
    {
        ...
        internal const HostNameComparisonMode HostNameComparisonMode = ServiceModel.HostNameComparisonMode.Exact;
    ...
    internal static class ConnectionOrientedTransportDefaults
    {
        ...
        internal const HostNameComparisonMode HostNameComparisonMode = ServiceModel.HostNameComparisonMode.StrongWildcard;
        ...
        internal const TransferMode TransferMode = ServiceModel.TransferMode.Buffered;
