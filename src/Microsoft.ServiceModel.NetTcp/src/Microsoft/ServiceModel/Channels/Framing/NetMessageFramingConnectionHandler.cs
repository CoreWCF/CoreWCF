...
namespace Microsoft.ServiceModel.Channels.Framing
{
    public class NetMessageFramingConnectionHandler : ConnectionHandler
    {
        ...
        public override Task OnConnectedAsync(ConnectionContext context)
        {
            ...
            //// TODO: Pool ServerModeDecoder
            //var modeDecoder = new ServerModeDecoder();
            //await modeDecoder.ReadModeAsync(inputPipe);
            //connection.FramingMode = modeDecoder.Mode;
            //Console.WriteLine($"Version {modeDecoder.MajorVersion}.{modeDecoder.MinorVersion} - {modeDecoder.Mode}");
            //FramingConnectionContext connectionContext;
            //switch(modeDecoder.Mode)
            //{
            //    case FramingMode.Duplex:
            //        connectionContext = new DuplexFramingConnectionContext(connection, this);
            //        break;

            //    case FramingMode.Singleton:
            //        connectionContext = new SingletonFramingConnectionContext(connection, this);
            //        break;

            //    default:
            //        {
            //            // TODO: Implement the failure code path
            ...
            //await connectionContext.CompleteHandshakeAsync();
        }
    }
}
