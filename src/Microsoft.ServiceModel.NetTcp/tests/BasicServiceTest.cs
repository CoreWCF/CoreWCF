...
using Xunit;
using NetTcpBinding = Microsoft.ServiceModel.NetTcpBinding;
...
public static class BasicServiceTest
{
    ...
    //                { Security = new Microsoft.ServiceModel.NetTcpSecurity
    //                    { Mode = Microsoft.ServiceModel.SecurityMode.None }
    //                };
