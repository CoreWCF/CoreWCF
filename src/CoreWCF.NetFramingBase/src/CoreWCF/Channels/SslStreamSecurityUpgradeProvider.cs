...
namespace CoreWCF.Channels
{
    internal class SslStreamSecurityUpgradeProvider : StreamSecurityUpgradeProvider, IStreamUpgradeChannelBindingProvider
    {
        ...
        // This is the equivalent of X509ClientCertificateAuthentication.DefaultCertificateValidator
        private static X509CertificateValidator s_defaultX509CertificateValidator = X509CertificateValidator.CreateChainTrustValidator(true, new X509ChainPolicy { RevocationMode = X509RevocationMode.Online });
        ...
        public SecurityTokenAuthenticator ClientCertificateAuthenticator
        {
            get
            {
                ...
                {
                    _clientCertificateAuthenticator = new X509SecurityTokenAuthenticator(s_defaultX509CertificateValidator);
                }
