...
namespace CoreWCF.Channels
{
    public abstract class ConnectionOrientedTransportBindingElement : TransportBindingElement, IWsdlExportExtension, IPolicyExportExtension
    {
        ...
        protected ConnectionOrientedTransportBindingElement() : base()
        {
        ...
        protected ConnectionOrientedTransportBindingElement(ConnectionOrientedTransportBindingElement elementToBeCloned) : base(elementToBeCloned)
        {
        ...
        protected abstract string WsdlTransportUri { get; }
        ...
        // Originally lived on ConnectionOrientedTransportChannelListener in WCF
        internal protected virtual bool SupportsUpgrade(StreamUpgradeBindingElement streamUpgradeBindingElement) => true;
