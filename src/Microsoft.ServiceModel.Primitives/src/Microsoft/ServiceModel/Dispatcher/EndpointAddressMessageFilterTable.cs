...
{
    using QName = Microsoft.ServiceModel.Dispatcher.EndpointAddressProcessor.QName;
    using HeaderBit = Microsoft.ServiceModel.Dispatcher.EndpointAddressProcessor.HeaderBit;
