    ...
    public sealed partial class OperationInvokerGenerator
    {
        private sealed class Emitter
        {
            ...
            public Emitter(in OperationInvokerSourceGenerationContext sourceGenerationContext, in SourceGenerationSpec generationSpec)
            {
                ...
                _registrations = new List<string>();
            }
...
""");
                ...
                {
                    _builder.AppendLine($"{indentor}{registration}");
                }
                indentor.Decrement();
                _builder.AppendLine($"{indentor}}}");
                indentor.Decrement();
            ...
            {
                var indentor = new Indentor();
                string operationInvokerTypeName = GetOperationInvokerTypeName();
                _builder.AppendLine($$"""
namespace CoreWCF.Dispatcher
{
...
""");
                ...
                _registrations.Add(string.Concat(operationInvokerTypeName, ".RegisterOperationInvoker();"));
                indentor.Decrement();
                _builder.AppendLine($"{indentor}}}");
                ...
                string GetOperationInvokerTypeName()
                {
                    StringBuilder builder = new();
                    builder.Append(operationContractSpec.Method!.ToDisplayString());
                    builder.Replace(".", "_")
                        .Replace("<", "_")
                        .Replace(">", "_")
                        .Replace("(", "_")
                        ...
                        .Replace(", ", "_")
                        .Replace(" ", "_");
                    builder.Append("OperationInvoker");
