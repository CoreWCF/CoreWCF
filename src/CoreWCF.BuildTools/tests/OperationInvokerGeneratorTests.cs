...
""")
                    ...
                    GeneratedSources =
                    {
                        (typeof(OperationInvokerGenerator), "MyProject_IIdentityService_Echo_string_ref_bool_out_int__OperationInvoker.g.cs", SourceText.From($$"""
using System;
using System.Threading.Tasks;
...
""")
                    ...
                    GeneratedSources =
                    {
                        (typeof(OperationInvokerGenerator), "MyProject_IIdentityService_Echo_System_Collections_Generic_List-string-__OperationInvoker.g.cs", SourceText.From($$"""
using System;
using System.Threading.Tasks;
...
""")
                    ...
                    GeneratedSources =
                    {
                        (typeof(OperationInvokerGenerator), "MyProject_IIdentityService_Echo_params_string____OperationInvoker.g.cs", SourceText.From($$"""
using System;
using System.Threading.Tasks;
...
""")
                    ...
                    GeneratedSources =
                    {
                        (typeof(OperationInvokerGenerator), "MyProject_IIdentityService_Echo_string__OperationInvoker.g.cs", SourceText.From($$"""
using System;
using System.Threading.Tasks;
