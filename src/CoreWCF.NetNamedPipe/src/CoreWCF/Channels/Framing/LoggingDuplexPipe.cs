...
namespace CoreWCF.Channels.Framing
{
    ...
    {
        public LoggingDuplexPipe(IDuplexPipe transport, NetNamedPipeTrace logger) :
    ...
    internal sealed class LoggingStream : Stream
    {
        ...
        private readonly NetNamedPipeTrace _logger;

        public LoggingStream(Stream inner, NetNamedPipeTrace logger)
        {
            _inner = inner;
            _logger = logger;
        }
