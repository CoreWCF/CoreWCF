...
namespace Microsoft.ServiceModel.Channels
{
    internal static class AddressingVersionExtensions
    {
        ...
        private static StringGetter GetStringGetterForProperty(string propName)
        {
            ...
            var getterPropInfo = typeof(AddressingVersion).GetProperty(propName, BindingFlags.NonPublic | BindingFlags.Public);
            var getterMethodInfo = getterPropInfo.GetGetMethod();
