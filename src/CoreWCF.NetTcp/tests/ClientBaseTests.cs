    ...
    public class ClientBaseTest
    {
        ...
        public void VariousClientBase(string cacheSetting)
        {
            ...
            {               
                ...
                EchoClient proxy1 = new EchoClient(ClientHelper.GetBufferedModeBinding(), new EndpointAddress("net.tcp://localhost:8808/BasicWcfService/nettcp.svc/Buffered"));
                ...
                EchoClient proxy2 = new EchoClient(ClientHelper.GetBufferedModeBinding(), new EndpointAddress("net.tcp://localhost:8808/BasicWcfService/nettcp.svc/Buffered")); // getting endpoint from config
#if NET472
                ...
                EchoClient proxy3 = new EchoClient(ClientHelper.GetBufferedModeBinding(), new EndpointAddress("net.tcp://localhost:8808/BasicWcfService/nettcp.svc/Buffered")); // getting endpoint from config
        ...
        internal class Startup
        {
            ...
            public void Configure(IApplicationBuilder app, IHostingEnvironment env)
            {
                app.UseServiceModel(builder =>
                {
                    ...
                    builder.AddServiceEndpoint<Services.Echo, ServiceContract.IEcho>(new CoreWCF.NetTcpBinding(CoreWCF.SecurityMode.None), "/BasicWcfService/nettcp.svc/Buffered");
                });
            }
        }
    }
