...
{
    internal class NetTcpExceptionConvertingDuplexPipe : IDuplexPipe
    {
        public NetTcpExceptionConvertingDuplexPipe(IDuplexPipe innerDuplexPipe)
        {
            Input = new NetTcpExceptionConvertingPipeReader(innerDuplexPipe.Input);
            Output = new NetTcpExceptionConvertingPipeWriter(innerDuplexPipe.Output);
        }

        public PipeReader Input { get; }
        public PipeWriter Output { get; }

        private class NetTcpExceptionConvertingPipeReader : PipeReader
        {
            private PipeReader _input;

            public NetTcpExceptionConvertingPipeReader(PipeReader input) => _input = input;
        ...
        private class NetTcpExceptionConvertingPipeWriter : PipeWriter
        {
            private PipeWriter _output;

            public NetTcpExceptionConvertingPipeWriter(PipeWriter output) => _output = output;
